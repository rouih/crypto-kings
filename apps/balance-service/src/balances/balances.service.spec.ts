...
describe('BalancesService', () => {
  ...
  it('should throw error if rate for a currency is missing', async () => {
    ...
    jest
      .spyOn(balancesRepository, 'getAllUserBalances')
      .mockResolvedValue(mockUserBalances);
  ...
  it('should add balance correctly', async () => {
    ...
    jest
      ...
      .mockResolvedValue(mockUserBalances);
    jest
      .spyOn(balancesRepository, 'saveUserBalances')
      .mockResolvedValue(undefined);

    await balancesService.addBalance(
      '1',
      addBalanceDto.asset,
    ...
    expect(balancesRepository.saveUserBalances).toHaveBeenCalledWith('123', {
      bitcoin: 15,
      ethereum: 10,
    });
  });
