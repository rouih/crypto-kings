import { Controller, Post, Put, Body, Headers, Delete, Get, Query, Param, Inject } from '@nestjs/common';
...
export class BalancesController {
  ...
  async getTotalBalance(
    ...
    try {
      ...
      this.logger.error(`Error retrieving total balance for user ${userId} in ${getTotalBalanceDto.targetCurrency}:`, error);
      throw new InternalServerException(error);
    }
  }
}
